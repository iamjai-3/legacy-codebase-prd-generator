...
class TestCodeExtractor:
    ...
    def test_determine_file_type_adapter(self):
        ...
        file_type = extractor._determine_file_type(
            Path("UserAdapter.java"), "public class UserAdapter extends BaseAdapter {}"
        )
    ...
    def test_determine_file_type_service(self):
        ...
        file_type = extractor._determine_file_type(
            Path("UserService.java"), "public class UserService {}"
        )
...
class TestAgentContext:
    ...
    def test_context_with_additional(self):
        ...
        context = AgentContext(form_name="le01", additional_context={"project": "test"})
